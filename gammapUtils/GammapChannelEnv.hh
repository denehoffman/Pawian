...
public:
  ...
  std::map<std::string, std::vector<short>> dropGammapLForParticleData() {
    return _dropGammapLForParticleData;
  }
  virtual const std::string channelTypeName() { return "gammap"; }
  virtual std::shared_ptr<AbsHist>
  CreateHistInstance(std::string additionalSuffix);
