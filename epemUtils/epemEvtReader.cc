...
epemEvtReader::epemEvtReader()
{}

epemEvtReader::epemEvtReader(const std::vector<std::string>& files, int particles, int skip, bool useWeight):
...
bool epemEvtReader::fillAll(EventList& evtList)
{
