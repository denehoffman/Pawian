  ...
  ,_fixPrimaryChannelScaling(true)  
{
  ...
  _common->add_options()
    ...
    ("ratioMcToData",po::value<double>(&_ratioMcToData),  "number of MC events defined by ratio #MCs/#Data")
    ("ratioTruthToMc",po::value<double>(&_ratioTruthToMc),  "number of truth events defined by ratio #truths/#Mcs; needed only for qaModeEffCorrection")
