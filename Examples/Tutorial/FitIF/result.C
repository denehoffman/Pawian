{
  ...
  evaluation0.push_back(1.00308e+06);
  evaluation1.push_back(1.54978e+07);

  iteration.push_back(1000);
  evaluation0.push_back(27936.9);
  evaluation1.push_back(27936.9);

  iteration.push_back(2000);
  evaluation0.push_back(27935.1);
  evaluation1.push_back(27935.1);

  iteration.push_back(3000);
  evaluation0.push_back(27604.6);
  evaluation1.push_back(27604.6);

  iteration.push_back(4000);
  evaluation0.push_back(27366.7);
  evaluation1.push_back(27366.7);

  iteration.push_back(5000);
  evaluation0.push_back(27363.5);
  evaluation1.push_back(27363.5);

  iteration.push_back(6000);
  evaluation0.push_back(27327.7);
  evaluation1.push_back(27327.7);

  iteration.push_back(7000);
  evaluation0.push_back(27279);
  evaluation1.push_back(27279);

  iteration.push_back(8000);
  evaluation0.push_back(22175.4);
  evaluation1.push_back(22175.4);

  iteration.push_back(9000);
  evaluation0.push_back(14841.7);
  evaluation1.push_back(14841.7);

  iteration.push_back(10000);
  evaluation0.push_back(11910.4);
  evaluation1.push_back(11910.5);
