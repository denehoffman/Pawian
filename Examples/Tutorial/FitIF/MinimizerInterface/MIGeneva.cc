...
#include "Examples/Tutorial/FitIF/MinimizerInterface/GStartIndividual.hh"
...
const double MIGeneva::exec(unsigned int Npar,  double* par,  double* min, double* max, double* err){
