...
JpsiToPhiPhiGamHist::JpsiToPhiPhiGamHist(boost::shared_ptr<const EvtDataBaseListNew> theEvtList) :
  _theTFile(0),
  _dalitzDataHist(0),
  _dalitzMcHist(0),
  _dalitzFittedHist(0),
 ...
 const std::vector<EvtDataNew*> mcList=theEvtList->getMcVecs();  
  ...
  while(it!=mcList.end())
    { 
      ...
      plotCostPhi_PhiPhiHeli(_costPhi_KpKmFittedHist, _phiPhi_KpKmFittedHist, (*it)->FourVecsDec[enumJpsiGamX4V::V4_KpKm_HeliKsKlKpKm], evtWeight); 
...
// JpsiToPhiPhiGamHist::JpsiToPhiPhiGamHist(JpsiGamKsKlKKProdLh* theJpsiGamKsKlKKLh, fitParams& fitParam, FitParamErrorMatrix* theErrorMatrix) :
//   _theTFile(0),
//   _dalitzDataHist(0),
//   _dalitzMcHist(0),
//   _dalitzFittedHist(0),
...
JpsiToPhiPhiGamHist::~JpsiToPhiPhiGamHist()
{
  _theTFile->Write();
  _theTFile->Close();
}

void JpsiToPhiPhiGamHist::initRootStuff()
{
...
void JpsiToPhiPhiGamHist::plotDalitz(TH2F* theHisto,  EvtDataNew* theData, double weight)
{
  Vector4<double>& V4_KsKl_HeliPsi = theData->FourVecsDec[enumJpsiGamX4V::V4_KsKl_HeliPsi]  ;
...
void JpsiToPhiPhiGamHist::plotPhiPhi(TH1F* theHisto, EvtDataNew* theData, double weight){
  Vector4<double>& v4 = theData->FourVecsDec[enumJpsiGamX4V::V4_KsKlKpKm_HeliPsi];
  theHisto->Fill( v4.M(), weight );
}

void JpsiToPhiPhiGamHist::plotKsKl(TH1F* theHisto, EvtDataNew* theData, double weight){
  Vector4<double>& v4 = theData->FourVecsDec[enumJpsiGamX4V::V4_KsKl_HeliPsi]; 
  theHisto->Fill( v4.M(), weight ); 
}
void JpsiToPhiPhiGamHist::plotKpKm(TH1F* theHisto, EvtDataNew* theData, double weight){
  Vector4<double>& v4 = theData->FourVecsDec[enumJpsiGamX4V::V4_KpKm_HeliKsKlKpKm]; 
  theHisto->Fill( v4.M(), weight );   
}

void JpsiToPhiPhiGamHist::plotCostPhiKs(TH1F* theCostHisto,  TH1F* thePhiHisto, EvtDataNew* theData, double weight){
  Vector4<double>& v4 = theData->FourVecsDec[enumJpsiGamX4V::V4_Ks_HeliKsKl]; 
  theCostHisto->Fill( v4.CosTheta(), weight );
  thePhiHisto->Fill( v4.Phi(), weight );
}

void JpsiToPhiPhiGamHist::plotCostPhiKp(TH1F* theCostHisto,  TH1F* thePhiHisto, EvtDataNew* theData, double weight){
  Vector4<double>& v4 = theData->FourVecsDec[enumJpsiGamX4V::V4_Kp_HeliKpKm]; 
  theCostHisto->Fill( v4.CosTheta(), weight );
  thePhiHisto->Fill( v4.Phi(), weight );
}

void JpsiToPhiPhiGamHist::plotCostGam(TH1F* theCostHisto, EvtDataNew* theData, double weight){
  Vector4<double>& v4 = theData->FourVecsDec[enumJpsiGamX4V::V4_gamma_HeliPsi]; 
  theCostHisto->Fill( v4.CosTheta(), weight );
}

void JpsiToPhiPhiGamHist::plotCostPhi_PhiPhiHeli(TH1F* theCostHisto, TH1F* thePhiHisto, const Vector4<double>& the4Vec, double weight){
  theCostHisto->Fill( the4Vec.CosTheta(), weight);
  thePhiHisto->Fill( the4Vec.Phi(), weight);
}

void JpsiToPhiPhiGamHist::plotChi(TH1F* theChiHisto, EvtDataNew* theData, double weight){
//   Vector4<double>& V4_KsKlKpKm_HeliPsi = theData->FourVecsDec[enumJpsiGamX4V::V4_KsKlKpKm_HeliPsi]  ;
//   Vector4<double>& V4_Ks_HeliPsi= theData->FourVecsDec[enumJpsiGamX4V::V4_Ks_HeliPsi] ;
...
//   double thePhiPhiDecayPlaneAngle = decayAngleChi( V4_KsKlKpKm_HeliPsi, V4_Kp_HeliPsi, V4_Km_HeliPsi, V4_Ks_HeliPsi, V4_Kl_HeliPsi   );
  ...
  Vector4<double>& V4_normKpKmDecHeliKsKlKpKm = theData->FourVecsDec[enumJpsiGamX4V::V4_normKpKmDecHeliKsKlKpKm];
  Vector4<double>& V4_normKsKlDecHeliKsKlKpKm = theData->FourVecsDec[enumJpsiGamX4V::V4_normKsKlDecHeliKsKlKpKm];
...
void  JpsiToPhiPhiGamHist::fillTuple( TNtuple* theTuple, EvtDataNew* theData, double weight)
{
  ...
  Vector4<double>& V4_KsKl_HeliKsKlKpKm= theData->FourVecsDec[enumJpsiGamX4V::V4_KsKl_HeliKsKlKpKm] ;
  Vector4<double>& V4_KpKm_HeliKsKlKpKm= theData->FourVecsDec[enumJpsiGamX4V::V4_KpKm_HeliKsKlKpKm] ;
  Vector4<double>& V4_Ks_HeliKsKl= theData->FourVecsDec[enumJpsiGamX4V::V4_Ks_HeliKsKl] ;
...
double JpsiToPhiPhiGamHist::decayAngleChi(const Vector4<double>& v4_p,const Vector4<double>& v4_d1,
