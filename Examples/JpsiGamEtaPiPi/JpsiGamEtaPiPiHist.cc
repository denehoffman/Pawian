...
JpsiGamEtaPiPiHist::JpsiGamEtaPiPiHist(boost::shared_ptr<AbsLh> theJpsiGamEtaPiPiLh, fitParams& theFitParams)
 :
	_theTFile(0),
	_dalitzDataHist(0),
	_dalitzMcHist(0),
...
void JpsiGamEtaPiPiHist::plotCostPhi_PiPiHeli(TH1F* theCostHisto, TH1F* thePhiHisto, EvtData* theData, double weight){
	Vector4<double> v4 = theData->FourVecs[enumJpsiGamEtaPiPiData::V4_PipPim_HeliEtaPipPim];
	theCostHisto->Fill( v4.CosTheta(), weight);
	thePhiHisto->Fill( v4.Phi(), weight);
}

void JpsiGamEtaPiPiHist::plotCostPhi_EtaPiHeli(TH1F* theCostHisto, TH1F* thePhiHisto, EvtData* theData, double weight){
