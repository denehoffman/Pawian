#ifndef _K1400Spin02Lh_H
#define _K1400Spin02Lh_H
...
class K1400Spin02Lh : public AbsPsi2SToKpKmPiGamLh{
...
public:
  ...
  ///Constructor 
  K1400Spin02Lh(boost::shared_ptr<const Psi2SToKpKmPiGamEventList>, boost::shared_ptr<const Psi2SToKpKmPiGamStates>);
  K1400Spin02Lh(boost::shared_ptr<AbsPsi2SToKpKmPiGamLh>);

  /** Destructor */
  virtual ~K1400Spin02Lh();

  virtual AbsPsi2SToKpKmPiGamLh* clone_() const {
    return new K1400Spin02Lh(_Psi2SToKpKmPiGamEvtListPtr, _Psi2SToKpKmPiGamStatesPtr);
  }
