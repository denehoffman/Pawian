...
Psi2SToKpKmPiGamReader::Psi2SToKpKmPiGamReader()
{}

Psi2SToKpKmPiGamReader::Psi2SToKpKmPiGamReader(const std::vector<std::string>& files, int particles, int skip):
...
bool Psi2SToKpKmPiGamReader::fillAll(EventList& evtList)
{
