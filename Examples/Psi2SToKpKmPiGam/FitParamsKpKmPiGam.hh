...
struct paramKpKmPiGam
{
  ...
  std::map< boost::shared_ptr<const JPCLS>, pair<double, double>, pawian::Collection::SharedPtrLess > ChiToK1680_1_K;
  ...
  std::map< boost::shared_ptr<const JPCLS>, pair<double, double>, pawian::Collection::SharedPtrLess > ChiToKKPi;
  pair<double, double> BwK890;
  pair<double, double> BwK1400_0;
  pair<double, double> BwK1400_1;
  pair<double, double> BwK1400_2;
  pair<double, double> BwK1680_1;
...
struct paramEnumKpKmPiGam{
  enum {ChiGam=0, K890K, K_0_1400K, K_1_1400K, K_2_1400K, K_1_1680K, a980Pi, KappaK, KKPi, nAmps,
	K890=nAmps, K_0_1400, K_1_1400, K_2_1400,  K_1_1680, Kappa, nMasses,
