...
private:
  ...
  complex<double> calcOmegaProdAmp(Spin Minit, Spin lamomega, std::map< boost::shared_ptr<const JPCLSls>, pair<double, double>, pawian::Collection::SharedPtrLess >& fitParm, OmegaPiDataLS::OmPiEvtDataLS* theData);
