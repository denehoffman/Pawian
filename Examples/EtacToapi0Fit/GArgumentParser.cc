...
#include "Examples/EtacToapi0Fit/GArgumentParser.hh"
...
namespace Gem
{
  namespace GenEvA
  {
	...
	config.add_options()
	  ...
	  ("minAMass", po::value<double>(&minAMass)->default_value(DEFAULTMINAMASS),
	   "Lower boundary for mass of the a meson")
	  ("maxAMass", po::value<double>(&maxAMass)->default_value(DEFAULTMAXAMASS),
	   "Upper boundary for mass of the a meson")
	  ("minAWidth", po::value<double>(&minAWidth)->default_value(DEFAULTMINAWIDTH),
	   "Lower boundary for width of the a meson")
	  ("maxAWidth", po::value<double>(&maxAWidth)->default_value(DEFAULTMAXAWIDTH),
	   "Upper boundary for width of the a meson")
	  ("minSpin0Cont", po::value<double>(&minSpin0Cont)->default_value(DEFAULTMINSPIN0CONT),
	   "Lower boundary for the content of spin 0 resonance")
	  ("maxSpin0Cont", po::value<double>(&maxSpin0Cont)->default_value(DEFAULTMAXSPIN0CONT),
	   "Upper boundary for the content of spin 0 resonance")
	  ("minSpin1Cont", po::value<double>(&minSpin1Cont)->default_value(DEFAULTMINSPIN1CONT),
	   "Lower boundary for the content of spin 1 resonance")
	  ("maxSpin1Cont", po::value<double>(&maxSpin1Cont)->default_value(DEFAULTMAXSPIN1CONT),
	   "Upper boundary for the content of spin 1 resonance")
	  ("minSpin2Cont", po::value<double>(&minSpin2Cont)->default_value(DEFAULTMINSPIN2CONT),
	   "Lower boundary for the content of spin 2 resonance")
	  ("maxSpin2Cont", po::value<double>(&maxSpin2Cont)->default_value(DEFAULTMAXSPIN2CONT),
	...
	if(verbose){
	  std::cout << std::endl
		    ...
		    << "minAMass = " << minAMass << std::endl
		    << "maxAMass = " << maxAMass << std::endl
		    << "minAWidth = " << minAWidth << std::endl
		    << "maxAWidth = " << maxAWidth << std::endl
		    << "minSpin0Cont = " << minSpin0Cont << std::endl
		    << "maxSpin0Cont = " << maxSpin0Cont << std::endl
		    << "minSpin1Cont = " << minSpin1Cont << std::endl
		    << "maxSpin1Cont = " << maxSpin1Cont << std::endl
