...
namespace Gem
{
  namespace GenEvA
  {
    ...
    const double DEFAULTMINAMASS=0.7;
    const double DEFAULTMAXAMASS=2.3;
    const double DEFAULTMINAWIDTH=0.01;
    const double DEFAULTMAXAWIDTH=0.8;
    const double DEFAULTMINSPIN0CONT=0.;
    const double DEFAULTMAXSPIN0CONT=1.;
    const double DEFAULTMINSPIN1CONT=0.;
    const double DEFAULTMAXSPIN1CONT=1.;
