...
public:
  ...
  ///Constructor 
  Hyp5Lh(boost::shared_ptr<const Psi2STo2K2PiGamEvtList>, const std::map<const std::string, bool>& hypMap, bool cacheAmps=false);
  Hyp5Lh(boost::shared_ptr<AbsPsi2STo2K2PiGamLh>, const std::map<const std::string, bool>& hypMap, bool cacheAmps=false);

  /** Destructor */
  virtual ~Hyp5Lh();

  virtual AbsPsi2STo2K2PiGamLh* clone_(){
    return new Hyp5Lh(_Psi2STo2K2PiGamEvtListPtr, _hypMap, _cacheAmps);
  }
...
protected:
  ...
  bool _K_1_2400KToK_0_1430Hyp5;
  bool _K_2_2400KTof980Hyp5;
  bool _K_2_2400KTof_0_1710Hyp5;
