...
Hyp5Lh::Hyp5Lh(boost::shared_ptr<const Psi2STo2K2PiGamEvtList> theEvtList, const std::map<const std::string, bool>& hypMap, boost::shared_ptr<Psi2STo2K2PiGamStates> theStatesPtr, bool cacheAmps) :
  ...
  ,_doHyp5(true)
  ,_K_0_2400KHyp5(false)
  ,_K_0_2400KTof_0_1710Hyp5(false)
  ,_K_1_2400KHyp5(false)
  ,_K_1_2400KTof_0_1710Hyp5(false)
  ,_K_1_2400KToK_0_1430Hyp5(false)
  ,_K_2_2400KTof980Hyp5(false)
  ,_K_2_2400KTof_0_1710Hyp5(false)
  ,_ChiToK_0_1430KPiHyp5(false)
  ,_ChiToK892KPiHyp5(false)
  , _nFitParams(0)
