...
public:
  ...
  ///Constructor 
  Hyp6Lh(boost::shared_ptr<const Psi2STo2K2PiGamEvtList>, boost::shared_ptr<const Psi2STo2K2PiGamStates>, const std::map<const std::string, bool>& hypMap);
  ...
  virtual AbsPsi2STo2K2PiGamLh* clone_() const{
    return new Hyp6Lh(_Psi2STo2K2PiGamEvtListPtr, _Psi2STo2K2PiGamStatesPtr, _hypMap);
  }
