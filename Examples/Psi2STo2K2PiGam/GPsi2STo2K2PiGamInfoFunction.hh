...
#ifndef _GPsi2STo2K2PiGamInfoFunction_H
#define _GPsi2STo2K2PiGamInfoFunction_H
	...
	void informationFunction(const infoMode& im, GEvolutionaryAlgorithm * const gbp){
		...
		case Gem::GenEvA::INFOPROCESSING:
		{
			...
			for(std::size_t p=0; p<nInfoIndividuals_; p++) {
				...
				boost::shared_ptr<GPsi2STo2K2PiGamIndividual> gdii_ptr = gbp->individual_cast<GPsi2STo2K2PiGamIndividual>(p);
