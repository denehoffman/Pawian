...
// ParamDepFixedRatio class definition file. -*- C++ -*-
...
class ParamDepFixedRatio : public ParamDep
{
public:
  ParamDepFixedRatio(std::istringstream& configLine, std::shared_ptr<AbsPawianParameters> params);
  ~ParamDepFixedRatio();
