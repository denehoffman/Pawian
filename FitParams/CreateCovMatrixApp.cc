...
int main(int __argc,char *__argv[]){
  ...
  InfoMsg << "path to new serialization file: " << pathToNewSerializationFile << endmsg;
  ...
  std::map<std::string, std::map<std::string, double> > theCovMap;
  ...
  while (!asciiStream.eof()){
    ...
    theCovMap[firstName][secondName]=value;
  }

  PwaCovMatrix* thePwaCovMatrix = new PwaCovMatrix(theCovMap);
