...
complex<double> PhaseSpaceIsobarDudekUnstableRhoPi::factor(const double mass){
...
complex<double> PhaseSpaceIsobarDudekUnstableRhoPi::factor(const complex<double> mass){
  complex<double> rho(-ChewM(mass).imag(), 0.); 
  return rho;
}
